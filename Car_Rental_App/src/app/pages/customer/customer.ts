...
export class CustomerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!this.carRentalService.isUserAdmin()) {
      ...
      this.showNotification('error', 'Access denied. Management view is for administrators only.');
      return;
    }
    this.loadCustomers();
  }
  ...
  loadCustomers() {
    ...
    // Service handles returning all customers for admin, or empty array for non-admin
  ...
  // --- Modal Management (omitted for brevity, remains unchanged) ---
  ...
  // --- Form & Data Handling (omitted for brevity, remains unchanged) ---
