...
export class LayoutComponent implements OnInit {
  ...
  allNavItems: NavItem[] = [
    ...
    {
      name: 'Profile', // NEW NAV ITEM (FEATURE #4)
      path: '/profile',
      icon: '<path d="M15 6V3a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h2"/><path d="M10 2v20l2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1Z" />',
      adminOnly: false,
    },
  ];
  ...
  updateNavItems(): void {
    const isAdmin = this.carRentalService.isUserAdmin();
