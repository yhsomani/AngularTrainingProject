    ...
    <div class="min-h-screen bg-neutral-light px-4 py-8">
      <div class="mx-auto max-w-6xl space-y-8">
        <section
          ...
          <p class="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Vehicles remote</p>
          <h1 class="mt-3 text-3xl font-semibold text-neutral-dark">Fleet configuration lab</h1>
          <p class="mt-2 text-sm text-neutral">
            Validate drag-and-drop ordering, CRUD flows, and Tailwind styling without booting the host shell.
          </p>
        ...
        <section class="rounded-2xl border border-white/70 bg-white/95 p-4 shadow-lg">
          <div class="mb-4 flex items-center justify-between">
            <div>
              <p class="text-sm font-semibold text-neutral-dark">Vehicles module</p>
              <p class="text-xs text-neutral">The full management UI renders below for quick iteration.</p>
            </div>
            <span class="rounded-full bg-neutral-light px-3 py-1 text-xs font-semibold text-neutral">Drag-enabled</span>
          </div>
